			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action= "">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Name is required">
						...
						<input class="input100 input1000" type="text" name="name" placeholder="Name" required>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Email is required" >
						<span class="label-input100">Gender</span>
						<select style="height: 5vh;margin-bottom: 5px" class="input100" name="gender" required>
							<option>Male</option>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Mobile is required">
						...
						<input class="input100" name="mobile" placeholder="your number phone" required>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="repassword" placeholder="Re-password" required>
						<span class="focus-input100"></span>
					</div>
